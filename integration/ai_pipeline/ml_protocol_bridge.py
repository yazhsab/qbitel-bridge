...
from ai_engine.features.extractors import StatisticalFeatureExtractor, StructuralFeatureExtractor
...
class MLProtocolBridge:
    ...
    def _calculate_confidence(self, protocol_classification: Dict[str, Any], 
                            field_boundaries: List[Dict[str, Any]], 
    ...
    def _features_to_tensor(self, features: Dict[str, Any]) -> torch.Tensor:
        ...
        try:
            ...
            feature_keys = [
                'entropy', 'byte_frequency_variance', 'pattern_count',
                'packet_size', 'source_port', 'dest_port', 'time_of_day'
            ]
