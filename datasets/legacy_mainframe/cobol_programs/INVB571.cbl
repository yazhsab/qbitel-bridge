       ...
       DATE-WRITTEN. 1996-05-21.
       DATE-COMPILED. 2026-01-10.
       SECURITY. CONFIDENTIAL.
      *
      * Batch processing program for retail transactions
      * Domain: RETAIL
      ...
      *
       ...
       FILE-CONTROL.
           ...
           SELECT INVENTRY-FILE
               ASSIGN TO DDINVENT
               ORGANIZATION IS INDEXED
               ACCESS MODE IS DYNAMIC
               RECORD KEY IS INVENTRY-KEY
               FILE STATUS IS WS-INVE-STATUS.
           SELECT ORDER-FILE
               ASSIGN TO DDORDER
               ORGANIZATION IS SEQUENTIAL
               FILE STATUS IS WS-ORDE-STATUS.
       ...
       01 PRODUCT-RECORD.
          05 PRODUCT-KEY PIC X(10).
          05 PRODUCT-ID PIC 9(10).
          05 PRODUCT-DATA PIC X(50).
          05 PRODUCT-AMOUNT PIC S9(9)V99 COMP-3.
          05 FILLER PIC X(20).
       FD INVENTRY-FILE
           RECORDING MODE IS F
           BLOCK CONTAINS 0 RECORDS
       ...
       01 INVENTRY-RECORD.
          05 INVENTRY-KEY PIC X(10).
          05 INVENTRY-ID PIC 9(10).
          05 INVENTRY-DATA PIC X(50).
          05 INVENTRY-AMOUNT PIC S9(9)V99 COMP-3.
          05 FILLER PIC X(20).
       FD ORDER-FILE
           RECORDING MODE IS F
           BLOCK CONTAINS 0 RECORDS
       ...
       01 ORDER-RECORD.
          05 ORDER-KEY PIC X(10).
          05 ORDER-ID PIC 9(10).
          05 ORDER-DATA PIC X(50).
       ...
       01 CUSTOMER-RECORD.
          ...
          05 CUSTOMER-AMOUNT PIC S9(9)V99 COMP-3.
          05 FILLER PIC X(20).
      *
       WORKING-STORAGE SECTION.
      *--- PROGRAM CONSTANTS ---
       01 WS-CONSTANTS.
           05 WS-PROGRAM-NAME      PIC X(8) VALUE 'PRODUCT-'.
           05 WS-PROGRAM-VERSION   PIC X(6) VALUE '01.00'.
      *
      *--- FILE STATUS VARIABLES ---
       01 WS-FILE-STATUS-VARS.
           05 WS-PROD-STATUS     PIC XX VALUE SPACES.
           05 WS-INVE-STATUS     PIC XX VALUE SPACES.
           05 WS-ORDE-STATUS     PIC XX VALUE SPACES.
      ...
      *
       1200-OPEN-FILES.
           ...
           END-IF.
           OPEN OUTPUT INVENTRY-FILE
           IF WS-INVE-STATUS NOT = '00'
               DISPLAY 'ERROR OPENING INVENTRY-FILE: ' WS-INVE-STATUS
               SET ERROR-OCCURRED TO TRUE
               PERFORM 9999-ABORT-PROGRAM
           END-IF.
           OPEN I-O ORDER-FILE
           IF WS-ORDE-STATUS NOT = '00'
               DISPLAY 'ERROR OPENING ORDER-FILE: ' WS-ORDE-STATUS
               SET ERROR-OCCURRED TO TRUE
               PERFORM 9999-ABORT-PROGRAM
           END-IF.
