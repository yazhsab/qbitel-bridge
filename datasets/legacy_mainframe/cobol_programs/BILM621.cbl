       ...
       DATE-WRITTEN. 1984-12-18.
       DATE-COMPILED. 2026-01-10.
       SECURITY. CONFIDENTIAL.
      *
      * File maintenance utility for healthcare master files
      * Domain: HEALTHCARE
      ...
      *
       ...
       FILE-CONTROL.
           ...
           SELECT BILLING-FILE
               ...
               RECORD KEY IS BILLING-KEY
               FILE STATUS IS WS-BILL-STATUS.
           SELECT PROVIDER-FILE
               ASSIGN TO DDPROVID
               ORGANIZATION IS INDEXED
               ACCESS MODE IS DYNAMIC
               RECORD KEY IS PROVIDER-KEY
       ...
       01 BILLING-RECORD.
          05 BILLING-KEY PIC X(10).
          05 BILLING-PATIENT-ID PIC X(12).
          05 BILLING-MRN PIC 9(10).
          05 BILLING-DOS PIC 9(8).
          05 BILLING-CHARGE PIC S9(7)V99 COMP-3.
          05 FILLER PIC X(20).
       FD PROVIDER-FILE
           RECORDING MODE IS F
           BLOCK CONTAINS 0 RECORDS
           RECORD CONTAINS 100 CHARACTERS.
       01 PROVIDER-RECORD.
          05 PROVIDER-KEY PIC X(10).
          05 PROVIDER-PATIENT-ID PIC X(12).
          05 PROVIDER-MRN PIC 9(10).
          05 PROVIDER-DOS PIC 9(8).
          05 PROVIDER-CHARGE PIC S9(7)V99 COMP-3.
          05 FILLER PIC X(20).
      *
      ...
      *--- FILE STATUS VARIABLES ---
       01 WS-FILE-STATUS-VARS.
           ...
           05 WS-BILL-STATUS     PIC XX VALUE SPACES.
           05 WS-PROV-STATUS     PIC XX VALUE SPACES.
      *
      *--- WORKING VARIABLES ---
       01 WS-WORK-AREAS.
      ...
      *
       1200-OPEN-FILES.
           ...
           IF WS-BILL-STATUS NOT = '00'
               DISPLAY 'ERROR OPENING BILLING-FILE: ' WS-BILL-STATUS
               SET ERROR-OCCURRED TO TRUE
               PERFORM 9999-ABORT-PROGRAM
           END-IF.
           OPEN I-O PROVIDER-FILE
           IF WS-PROV-STATUS NOT = '00'
               DISPLAY 'ERROR OPENING PROVIDER-FILE: ' WS-PROV-STATUS
               SET ERROR-OCCURRED TO TRUE
               PERFORM 9999-ABORT-PROGRAM
           END-IF.
      *
