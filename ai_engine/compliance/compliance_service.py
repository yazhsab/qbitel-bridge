...
class ComplianceService:
    ...
    async def assess_compliance(
        ...
        try:
            ...
            try:
                ...
                self.logger.info(f"Assessment completed: {assessment_id} - {assessment.overall_compliance_score:.1f}%")
                return assessment
    ...
    async def get_compliance_dashboard(self, frameworks: List[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            # Calculate summary
            valid_frameworks = [f for f in dashboard_data["frameworks"].values() 
            ...
            if self.timescale_client:
                dashboard_data["trends"] = await self.timescale_client.get_compliance_trends(
                    frameworks, days=30
                )
