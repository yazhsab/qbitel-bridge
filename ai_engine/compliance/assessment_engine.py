    ...
    def _collect_network_config(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'listening_ports': [
                    conn.laddr.port for conn in psutil.net_connections('inet')
    ...
    def _collect_security_config(self) -> Dict[str, Any]:
        ...
        try:
            ...
            security_config['rate_limiting'] = {
                'enabled': getattr(self.config.security, 'enable_rate_limiting', False) if hasattr(self.config, 'security') else False,
                'rate_limit': getattr(self.config.security, 'rate_limit_per_minute', 0) if hasattr(self.config, 'security') else 0
            }
        ...
        try:
            return {
                'security_awareness_training': {
                    ...
                    'frequency': 'annual',
                    'topics_covered': ['phishing', 'password_security', 'data_protection']
                },
                'compliance_training': {
        ...
        try:
            ...
            if target_requirements:
                requirements_to_assess = [
                    req for req in requirements_to_assess 
    ...
    def _extract_evidence_for_requirement(
        ...
        for source in set(relevant_sources):
            try:
                ...
                if data:
                    evidence.append(ComplianceDataPoint(
                        source=source,
    ...
    def _create_requirement_assessment_prompt(
        ...
        for evidence_item in evidence:
            evidence_summary.append({
                ...
                'data': str(evidence_item.value)[:500] if isinstance(evidence_item.value, (dict, list)) else str(evidence_item.value)
            })
...
"""
    ...
    async def _generate_overall_assessment(
        ...
        for req_assessment in requirement_assessments:
            if req_assessment.status in [ComplianceStatus.NON_COMPLIANT, ComplianceStatus.PARTIALLY_COMPLIANT]:
                gap = ComplianceGap(
    ...
    async def get_compliance_summary(self, framework: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'high_priority_recommendations': len([r for r in assessment.recommendations if r.priority in [RequirementSeverity.CRITICAL, RequirementSeverity.HIGH]]),
