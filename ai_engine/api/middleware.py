...
class HealthChecker:
    ...
    async def check_llm_providers() -> Dict[str, str]:
        ...
        return {"openai": "healthy", "anthropic": "healthy", "ollama": "unknown"}

    @staticmethod
    async def check_databases() -> Dict[str, str]:
        """Check database connections."""
        return {"redis": "healthy", "chromadb": "healthy", "timescaledb": "unknown"}

    @staticmethod
    async def check_external_services() -> Dict[str, str]:
        """Check external service dependencies."""
        return {"prometheus": "healthy", "grafana": "unknown"}
