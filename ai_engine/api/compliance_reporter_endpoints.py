    ...
    try:
        ...
        try:
            for _ in range(min(limit, reporter.alert_queue.qsize())):
                ...
                alerts.append(ComplianceAlertResponse(
...
async def generate_audit_evidence(request: AuditRequestModel):
    ...
    **Features:**
    ...
    try:
        ...
        # Parse dates
        start_date = datetime.fromisoformat(request.start_date) if request.start_date else datetime.utcnow() - timedelta(days=30)
