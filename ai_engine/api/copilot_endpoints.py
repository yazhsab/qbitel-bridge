...
from ..copilot.protocol_copilot import create_protocol_copilot, CopilotQuery, CopilotResponse
from ..core.config import get_config
from ..core.exceptions import CronosAIException
from .auth import verify_token, get_current_user

# Metrics
COPILOT_API_REQUESTS = Counter('cronos_copilot_api_requests_total', 'Total copilot API requests', ['endpoint', 'status'])
COPILOT_API_DURATION = Histogram('cronos_copilot_api_duration_seconds', 'Copilot API request duration', ['endpoint'])
WEBSOCKET_CONNECTIONS = Counter('cronos_copilot_websocket_connections_total', 'Total WebSocket connections')
