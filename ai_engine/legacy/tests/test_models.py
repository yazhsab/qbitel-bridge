...
from ..models import (
    # Enums
    SystemType, Criticality, FailureType, SeverityLevel, MaintenanceType,
    PredictionHorizon, DecisionCategory, KnowledgeConfidenceLevel,
    
    # Data Models
    LegacySystemContext, SystemMetrics, TimeSeriesData,
    SystemFailurePrediction, MaintenanceRecommendation,
    SystemBehaviorPattern, FormalizedKnowledge,
    DecisionContext, ActionRecommendation, BusinessImpactAssessment
)
...
class TestSystemMetrics:
    ...
    def test_metrics_to_feature_vector(self, valid_metrics_data):
        ...
        expected_features = [
            ...
            "network_utilization", "response_time_ms", "error_rate",
            "transaction_rate", "availability"
        ]
...
def create_test_failure_prediction(system_id: str = "test_system") -> SystemFailurePrediction:
