...
class LegacySystemWhispererService:
    ...
    async def register_legacy_system(
        self, system_context: LegacySystemContext, enable_monitoring: bool = True
    ) -> Dict[str, Any]:
        """
    ...
    async def _generate_health_recommendations(
        ...
        recommendations = await self.recommendation_engine.generate_recommendations(
            decision_context=decision_context, system_analysis=analysis_results
        )
    ...
    async def capture_expert_knowledge(
        ...
        try:
            ...
            capture_result = await self.knowledge_capture.capture_expert_input(
                session_id=session_id, expert_input=expert_input, context=context
            )
    ...
    async def create_decision_support(
        ...
        try:
            ...
            return {"decision_recommendations": recommendations, "status": "success"}
