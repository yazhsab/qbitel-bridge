...
class TestVAEAnomalyDetector:
    ...
    async def test_initialize_detector_failure(self, detector):
        ...
        with patch('ai_engine.anomaly.vae_detector.VAEModel', side_effect=Exception("Init error")):
    ...
    def test_train_epoch(self, detector):
        ...
        detector.model.return_value = (torch.randn(10, 50), torch.randn(10, 16), torch.randn(10, 16))
        detector.model.loss_function = Mock(return_value={
