...
class TestMainEntryPoint:
    ...
    def test_main_development_mode(self, mock_config, mock_run_dev):
        ...
        # Mock sys.argv
        test_args = ['ai_engine', '--development', '--host', '127.0.0.1', '--port', '8000']
        with patch.object(sys, 'argv', test_args):
            try:
                main()
            except SystemExit:
        ...
        # Verify development server was called
    ...
    def test_main_with_grpc_enabled(self, mock_config):
        ...
        # Verify gRPC was enabled in config
        ...
        with patch.object(sys, 'argv', test_args):
            with patch('ai_engine.__main__.run_production_server'):
                with patch('logging.getLogger') as mock_logger:
                    ...
                    # Verify version info was logged
