...
class TestComplianceReportEndpoints:
    ...
    def mock_reporter(self):
        ...
        reporter.get_service_status = Mock(return_value={
        ...
        reporter.get_performance_metrics = Mock(return_value={
        ...
        reporter.regulatory_kb.get_framework_metadata = Mock(return_value={
    ...
    async def test_generate_compliance_report_success(self, mock_reporter):
        ...
        from ai_engine.api.compliance_reporter_endpoints import generate_compliance_report
        ...
        with patch('ai_engine.api.compliance_reporter_endpoints.get_compliance_reporter', return_value=mock_reporter):
    ...
    async def test_download_compliance_report(self):
        ...
        from ai_engine.api.compliance_reporter_endpoints import download_compliance_report
    ...
    async def test_start_continuous_monitoring_success(self, mock_reporter):
        ...
        from ai_engine.api.compliance_reporter_endpoints import start_continuous_monitoring
    ...
    async def test_get_compliance_alerts(self, mock_reporter):
        ...
        from ai_engine.compliance.compliance_reporter import ComplianceAlert, AlertSeverity
    ...
    async def test_list_compliance_frameworks(self, mock_reporter):
        ...
        from ai_engine.api.compliance_reporter_endpoints import list_compliance_frameworks
    ...
    def test_include_compliance_reporter_routes(self):
        ...
        from ai_engine.api.compliance_reporter_endpoints import include_compliance_reporter_routes
