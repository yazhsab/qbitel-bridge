...
class TestMainEntryPoint:
    ...
    def test_main_exception_handling(self, mock_config):
        ...
        with patch('ai_engine.__main__.run_production_server', side_effect=RuntimeError("Test error")):
            with pytest.raises(SystemExit) as exc_info:
                main()
    ...
    @patch('ai_engine.__main__.run_development_server')
    @patch('ai_engine.__main__.Config')
    @patch('sys.argv', ['ai_engine', '--development', '--host', 'localhost', '--port', '3000'])
    ...
    @patch('ai_engine.__main__.run_development_server')
    @patch('ai_engine.__main__.Config')
    @patch('sys.argv', ['ai_engine', '--development', '--enable-grpc', '--grpc-port', '50053'])
