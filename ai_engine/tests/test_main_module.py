...
class TestMainModule:
    ...
    async def test_shutdown_servers(self, mock_server):
        ...
        servers = {"rest": mock_server, "grpc": mock_server}
    ...
    async def test_health_check_loop(self, mock_config):
        ...
        with (
            patch("ai_engine.__main__.asyncio.sleep") as mock_sleep,
    ...
    def test_create_rest_server(self, mock_config):
        ...
        with (
            patch("ai_engine.__main__.FastAPI") as mock_fastapi,
    ...
    def test_get_system_info(self):
        ...
        with (
            patch("ai_engine.__main__.platform") as mock_platform,
    ...
    async def test_main_with_command_line_args(self):
        ...
        with (
            patch(
                "ai_engine.__main__.sys.argv",
                ["__main__.py", "--config", "test_config.yaml"],
            ),
