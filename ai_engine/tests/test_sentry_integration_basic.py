...
from ai_engine.core.sentry_integration import SentryErrorTracker, get_sentry_tracker, initialize_sentry
...
class TestSentryErrorTracker:
    ...
    def test_initialize_failure(self):
        ...
        with patch('ai_engine.core.sentry_integration.sentry_sdk.init', side_effect=Exception("Init failed")):
            tracker = SentryErrorTracker(
                dsn="https://test@sentry.io/123",
                environment="test",
                release="1.0.0"
