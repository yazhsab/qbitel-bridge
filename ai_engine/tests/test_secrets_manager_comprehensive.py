...
class TestSecretMetadata:
    ...
    def test_metadata_defaults(self):
        ...
        now = datetime.utcnow()
        metadata = SecretMetadata(key="test_key", backend=SecretBackend.ENVIRONMENT, created_at=now)
...
class TestSecretsManagerVault:
    ...
    def test_get_secret_from_vault(self, mock_vault_client):
        ...
        mock_vault_client.secrets.kv.v2.read_secret_version.return_value = {"data": {"data": {"value": "vault_secret"}}}
        with patch(
...
class TestSecretsManagerAWS:
    ...
    def test_get_secret_from_aws_binary(self, mock_aws_client):
        ...
        mock_aws_client.get_secret_value.return_value = {"SecretBinary": base64.b64encode(b"aws_secret")}
        with patch(
            "ai_engine.security.secrets_manager.boto3.client",
            return_value=mock_aws_client,
        ):
