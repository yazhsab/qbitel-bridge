...
from cloud_native.service_mesh.envoy.observability import MetricType, Metric, EnvoyObservability
...
class TestMetric:
    ...
    def test_metric_creation(self):
        ...
        metric = Metric(
            name="http_requests_total", metric_type=MetricType.COUNTER, value=100, labels={"service": "api", "status": "200"}
        )
...
class TestEnvoyObservability:
    ...
    def observability(self):
        ...
        return EnvoyObservability(enable_prometheus=True, enable_jaeger=True, enable_access_logs=True)
    ...
    def test_create_jaeger_config(self, observability):
        ...
        jaeger_config = observability.create_jaeger_config(collector_endpoint="http://jaeger:14268/api/traces")
    ...
    def test_custom_metrics(self, observability):
        ...
        observability.record_metric(
            name="custom_metric", metric_type=MetricType.COUNTER, value=1, labels={"component": "test"}
        )
        ...
        # Find custom metric
        custom_metric = next((m for m in metrics if m.name == "custom_metric"), None)
    ...
    def test_tracing_sampling_rate(self, observability):
        ...
        jaeger_config = observability.create_jaeger_config(
            collector_endpoint="http://jaeger:14268/api/traces", sampling_rate=0.1
        )
    ...
    def test_access_log_format(self, observability):
        ...
        access_log = observability.create_access_log_config(format_type="json")
    ...
    def test_admin_interface_config(self, observability):
        ...
        admin_config = observability.create_admin_config(address="0.0.0.0", port=9901)
