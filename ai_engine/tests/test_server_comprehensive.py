...
class TestAIEngineServerInitialize:
    ...
    async def test_initialize_success(self, mock_config):
        ...
        with patch('ai_engine.api.server.initialize_auth') as mock_init_auth, \
    ...
    async def test_initialize_rest_only(self):
        ...
        with patch('ai_engine.api.server.initialize_auth'), \
             patch('ai_engine.api.server.create_app') as mock_create_app:
...
class TestDevelopmentServer:
    ...
    def test_run_development_server_rest_only(self):
        ...
        with patch('ai_engine.api.server.create_app') as mock_create_app, \
...
class TestProductionServer:
    ...
    def test_run_production_server(self, mock_config):
        ...
        with patch('ai_engine.api.server.ServerManager') as mock_manager_class, \
...
class TestMainEntryPoint:
    ...
    def test_main_keyboard_interrupt(self):
        ...
        with patch('sys.argv', test_args), \
             patch('ai_engine.api.server.run_production_server', side_effect=KeyboardInterrupt()), \
    ...
    def test_main_exception(self):
        ...
        with patch('sys.argv', test_args), \
             patch('ai_engine.api.server.run_production_server', side_effect=Exception("Server error")), \
             patch('sys.exit') as mock_exit:
