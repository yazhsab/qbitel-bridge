...
class ThreatClassificationModel(BaseModel):
    ...
    def get_input_schema(self) -> Dict[str, Any]:
        """Get input schema."""
        return {"type": "tensor", "shape": [-1, self.feature_dim], "dtype": "float32"}
    ...
    async def _perform_ml_classification(self, features: np.ndarray, security_event: SecurityEvent) -> Dict[str, Any]:
        ...
        try:
            if self.classification_model:
                ...
                event_types = list(SecurityEventType)
                predicted_type = (
                    event_types[predicted_class_idx]
                    if predicted_class_idx < len(event_types)
    ...
    def _map_to_mitre_techniques(self, event: SecurityEvent) -> List[str]:
        ...
        mitre_mapping = {
            SecurityEventType.MALWARE_DETECTION: [
                "T1059",
                "T1055",
            ],  # Command Line Interface, Process Injection
            SecurityEventType.INTRUSION_ATTEMPT: [
                "T1190",
                "T1078",
            ...
            SecurityEventType.LATERAL_MOVEMENT: [
                "T1021",
                "T1570",
