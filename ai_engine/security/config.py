...
class LegacyResponseConfig:
    ...
    quarantine_methods: Dict[str, QuarantineMethod] = field(default_factory=lambda: {
...
class SecurityConfigManager:
    ...
    def _create_config_from_dict(self, config_dict: Dict[str, Any]) -> SecurityOrchestratorConfig:
        ...
        legacy_response = LegacyResponseConfig(
            ...
            quarantine_methods={
                k: QuarantineMethod(v) for k, v in legacy_response_dict.get("quarantine_methods", {}).items()
            }
        )
    ...
    def get_quarantine_method(self, system_type: str = "default") -> QuarantineMethod:
        ...
        return config.legacy_response.quarantine_methods.get(
            system_type, 
            QuarantineMethod.NETWORK_SEGMENTATION
        )
