...
from .base_connector import (
    BaseIntegrationConnector, IntegrationType, IntegrationConfig, IntegrationResult
)
...
from .communication_connector import CommunicationConnector, SlackConnector, EmailConnector
from .network_security_connector import NetworkSecurityConnector, FirewallConnector, IDSConnector
...
class IntegrationManager:
    ...
    def __init__(self):
        ...
        self.event_routing = {
            ...
            IntegrationType.NETWORK_SECURITY: ['response_execution', 'quarantine_events']
        }
    ...
    def _determine_response_targets(self, automated_response: AutomatedResponse) -> List[str]:
        ...
        for name, registration in self.integrations.items():
            ...
            # Network security systems for network-related responses
                ...
                network_actions = {'block_ip', 'quarantine', 'isolate_system', 'network_segmentation'}
    ...
    async def _background_connection_retry(self):
        ...
        while self._running:
            try:
                for name, registration in self.integrations.items():
                    if (not registration.enabled and 
                        registration.auto_retry and 
                        registration.current_failures > 0):
