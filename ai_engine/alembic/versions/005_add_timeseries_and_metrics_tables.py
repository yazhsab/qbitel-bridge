...
def upgrade() -> None:
    ...
    op.create_index("idx_pdm_protocol_time", "protocol_discovery_metrics", ["protocol_id", "time"], postgresql_using="btree")
    op.create_index("idx_pdm_phase", "protocol_discovery_metrics", ["discovery_phase", "time"], postgresql_using="btree")
