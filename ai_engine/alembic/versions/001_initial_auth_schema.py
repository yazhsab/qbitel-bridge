...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('role', sa.Enum('administrator', 'security_analyst', 'operator', 'viewer', 'api_user', name='userrole'), nullable=False),
        ...
        sa.Column('mfa_method', sa.Enum('totp', 'sms', 'email', 'hardware_token', name='mfamethod'), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('active', 'revoked', 'expired', name='apikeystatus'), nullable=False, default='active'),
    ...
    op.create_table(
        ...
        sa.Column('action', sa.Enum(
            ...
            'user_created', 'user_updated', 'user_deleted', 'oauth_login', 'saml_login',
            name='auditaction'
        ), nullable=False),
