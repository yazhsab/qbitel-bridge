...
def upgrade():
    ...
    op.create_index('idx_compliance_timestamp', 'ai_decision_audit', ['compliance_framework', 'timestamp'])
    op.create_index('idx_human_review_timestamp', 'ai_decision_audit', ['human_reviewed', 'timestamp'])
    ...
    op.create_index('idx_drift_alert', 'model_drift_metrics', ['model_name', 'drift_detected', 'timestamp'])
