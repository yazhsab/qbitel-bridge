"""
CRONOS AI - Custom Protocol Handler Code Generation
...
CODE_GENERATION_DURATION = Histogram(
    "cronos_code_generation_duration_seconds",
...
class ProtocolHandlerGenerator:
    ...
    async def generate_handler(
        ...
        try:
            ...
            raise CronosAIException(f"Code generation failed: {e}")
...
## Generated
This code was automatically generated by CRONOS AI Protocol Handler Generator.
"""
        return doc.strip()
