...
class TestProtocolSchema:
    ...
    @pytest.mark.parametrize("field_type,expected_valid", [
...
class TestGeneratedSDK:
    ...
    @pytest.mark.parametrize("language,expected_extensions", [
...
class TestTranslationResult:
    ...
    def test_translation_result_quality_assessment(self, sample_translation_result):
        ...
        is_successful = (
            sample_translation_result.confidence > 0.7 and
            len(sample_translation_result.validation_errors) == 0
        )
        ...
        duplicate_endpoints = [
            {
                'path': '/messages',
                'method': 'GET',
                'operation_id': 'get_messages_1'
            },
            {
                'path': '/messages',
                'method': 'GET',
                'operation_id': 'get_messages_2'
            }
        ]
