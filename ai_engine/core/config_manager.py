...
class ConfigManager:
    ...
    def load_config(self, config_file: Optional[str] = None, 
                   config_dict: Optional[Dict[str, Any]] = None) -> MainConfig:
    ...
    def _auto_load_config(self) -> MainConfig:
        ...
        env_files = [f"cronos_ai.{env}.yaml", f"cronos_ai.{env}.yml", f"cronos_ai.{env}.json"]
...
def load_config(config_file: Optional[str] = None, 
               ...
               config_dir: Optional[str] = None) -> MainConfig:
    """Load configuration."""
