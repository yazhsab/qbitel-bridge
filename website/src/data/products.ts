...
export const products: Product[] = [
  ...
  },
  {
    ...
    tagline: 'Industry-ready critical system playbooks',
    description: 'Packaged protocols, risk models, deployment templates, and evidence mappings for BPO/call centers, IoT, defense, banking, OT, healthcare, telecom, aviation, and automotive environments.',
    icon: 'store',
    href: '/industries',
    color: 'from-green-500 to-emerald-500',
    features: ['BPO Voice Shield', 'IoT Device Trust', 'Defense Mission Bridge', 'Banking Mainframe Shield'],
  },
  {
    id: 'zero-touch-security',
    title: 'Governed Protection Engine',
    tagline: 'Powerful controls under institutional approval',
    description: 'Policy-led fraud, threat, and PQC controls with confidence scoring, approval gates, rollback paths, simulation, and audit evidence for production-critical systems.',
    icon: 'shield',
    href: '/products/zero-touch-security',
    color: 'from-red-500 to-orange-500',
    features: ['Human approval gates for critical actions', 'Simulation and rollback paths', 'On-premise LLM inference (Ollama)', 'Full MITRE ATT&CK technique mapping'],
    metrics: [
      { label: 'Mode', value: 'Governed' },
      { label: 'Rollback', value: 'Required' },
      { label: 'Evidence', value: 'Full' },
    ],
  },
  {
